...
## 2026-04-02: トレンドヒント・キーワード複数選択実装

### 実装内容
- トレンドヒント：ページ読み込み時に今日の日付を渡してAIが動的生成
- キーワード複数選択：タップでトグル、スペース区切りで検索窓に反映

### 技術判断
- trend-hint APIはGETで実装（パラメータ不要）
- 全AI機能のモデルをgemini-2.5-flash-liteで統一
